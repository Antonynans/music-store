...
const Banner: React.FC = () => {
  ...
  return (
    <div className='xl:w-2/3 w-11/12 flex lg:h-[560px] px-5 py-14 lg:justify-end lg:flex-row flex-col relative items-center bg-[#ec5d49] gap-7 text-white container rounded-md overflow-hidden mx-auto bg-[url("/pattern-circles.svg")] bg-no-repeat bg-center bg-cover'>
      <div className="lg:absolute lg:max-w-106.5 lg:left-30 md:max-w-[12.3rem] max-w-[172px] -bottom-4">
      ...
      <div className="right-24 lg:w-[40%] lg:text-left text-center mt-8 flex flex-col lg:items-start items-center gap-8">
        <h1 className="flex flex-col text-5xl leading-14 uppercase">
          <span>zx9</span> speaker
        </h1>
        <p className="leading-6 font-semibold max-w-88">
          Upgrade to premium speakers that are phenomenally built to deliver
          truly remarkable sound.
        </p>
        <button
          className="bg-black py-4 px-8 mt-8 rounded-sm hoverBtn"
