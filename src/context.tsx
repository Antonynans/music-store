...
const defaultCartContext: ICartContextValue = {
  cart: [],
  increase: () => {},
  decrease: () => {},
  clearCart: () => {},
...
const CartContext = createContext<ICartContextValue>(defaultCartContext);

export const CartProvider: React.FC<IProps> = ({ children }) => {
  const [cart, setCart] = useLocalStorage<ICartItem[]>("cart", []);
